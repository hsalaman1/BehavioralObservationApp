...
export function AdminLogin({ onSuccess }) {
  ...
  return (
    <div className="md:mt-8 md:max-w-sm md:mx-auto">
      {/* Mobile: bottom-sheet slide-up. Desktop: centered card. */}
      <div className="fixed inset-x-0 bottom-0 bg-white rounded-t-2xl p-6 shadow-xl animate-slide-up md:static md:rounded-xl md:border md:border-gray-200 md:p-8 md:shadow-sm md:animate-none">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full bg-purple-600 text-white py-2.5 rounded-lg text-sm font-medium hover:bg-purple-700 transition-colors min-h-[44px]"
          >
            Sign In
          </button>
        </form>
